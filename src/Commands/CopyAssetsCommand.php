...
namespace Djurovicigoor\AppLifecycle\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for AppLifecycle plugin.
 *
...
{
    protected $signature = 'nativephp:app-lifecycle:copy-assets';

    protected $description = 'Copy assets for AppLifecycle plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for AppLifecycle');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for AppLifecycle');
    }
}